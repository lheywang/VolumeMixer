...
#define POWRBP_Pin GPIO_PIN_2
#define POWRBP_GPIO_Port GPIOD
...
#define LEDW1_Pin GPIO_PIN_8
#define LEDW1_GPIO_Port GPIOB
#define LEDW2_Pin GPIO_PIN_9
#define LEDW2_GPIO_Port GPIOB
