  ...
  if(hadc->Instance==ADC1)
  {
    ...
    */
    GPIO_InitStruct.Pin = adc_slider0_Pin|adc_slider1_Pin|adc_slider2_Pin|adc_slider3_Pin
                          |adc_slider4_Pin|vref_dig_Pin|vref_ana_Pin;
...
void HAL_TSC_MspInit(TSC_HandleTypeDef* htsc)
{
  ...
  if(htsc->Instance==TSC)
  {
    ...
    PB6     ------> TSC_G5_IO3
    */
    GPIO_InitStruct.Pin = mute5_Pin|mute4_Pin|mute3_Pin|mute1_Pin
                          |mute0_Pin;
    ...
    GPIO_InitStruct.Pin = capsense1_Pin|capsense0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TSC;
...
void HAL_TSC_MspDeInit(TSC_HandleTypeDef* htsc)
{
  if(htsc->Instance==TSC)
  {
    ...
    PB6     ------> TSC_G5_IO3
    */
    HAL_GPIO_DeInit(GPIOB, mute5_Pin|mute4_Pin|mute3_Pin|capsense1_Pin
                          |mute1_Pin|mute0_Pin|capsense0_Pin);
