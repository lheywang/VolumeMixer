...
The core of this FSM is developped into the [fsm.c](https://github.com/lheywang/VolumeMixer/blob/main/code/board/Core/Src/fsm/fsm.c) file.

That's this file, which contain quite a lot of code that control most, if not all the behaviors of the 
device.
